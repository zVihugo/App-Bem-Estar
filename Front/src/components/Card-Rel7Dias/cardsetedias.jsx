            ...
            {temRelatorio ? (
                <>
                    ...
                    <div className={styles.cardRelDescricao}>
                        <h1>Relatório dos últimos 7 dias</h1>
                ...
                <div className={styles.cardRelSemRelatorio}>
                    <h1>Você ainda não possui um relatório dos últimos 7 dias</h1>
                    <p>Para gerar um relatório, é necessário responder a autoavaliação.</p>
                    <p>Matenha uma ofensiva de 7 dias, para que você consiga visualizar esta funcionalidade.</p>
                </div>
            )}
        </div>
    );
